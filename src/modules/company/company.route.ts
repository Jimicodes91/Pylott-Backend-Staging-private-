...
import { createCompanyValidationRule, updateCompanyValidationRule } from '@/shared/validations/company';
...
export const companyRoutes = (prefix: string, server: Server) => {
  ...
  server.put(`${prefix}/:id`, authenticateUser, schemaValidator(updateCompanyValidationRule), companyController.updateCompany);
};
